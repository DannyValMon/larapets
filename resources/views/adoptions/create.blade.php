...
@section('title', 'Larapets: Create Adoption')
                ...
                @foreach ($pets as $pet)
                    <div class="card p-4 bg-slate-900/70">
                        <div class="flex flex-col items-center gap-3 text-center">
                            <img src="{{ asset($pet->photo ?? 'images/dashboard/modulo-pets.png') }}" alt="{{ $pet->name }}"
                            ...
                            <button class="btn btn-primary btn-sm text-white" disabled>Send Request</button>
                        </div>
                    </div>
                @endforeach
            </div>
